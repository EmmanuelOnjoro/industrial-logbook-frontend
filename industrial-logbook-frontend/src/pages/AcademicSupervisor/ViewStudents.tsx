  ...
  <div className="d-flex" style={{ minHeight: "100vh" }}>
    ...
    <div className="flex-grow-1 bg-light">
      ...
      <main className="container py-4">
        <h2 className="mb-4 text-maroon">View Students</h2>
        {/* Table of assigned students with filters goes here */}
        <div className="alert alert-info">Student list and filters coming soon.</div>
      </main>
    </div>
  </div>
);
